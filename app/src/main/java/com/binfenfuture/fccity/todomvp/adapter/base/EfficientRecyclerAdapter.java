package com.binfenfuture.fccity.todomvp.adapter.base;
...
/**
 * 给recyclerView通用的adapter
 * https://github.com/StanKocken/EfficientAdapter
 * <p>
 * 注意！onClick事件请使用{@link #setOnItemClickListener(OnItemClickListener)}，不要在ViewHolder绑定的时候设置
 *
 * @param <T>
 */
public class EfficientRecyclerAdapter<T> extends RecyclerView.Adapter<EfficientViewHolder>
    ...
    public static final int LOADING_MORE_ITEM = -1;
    ...
    public void onBindViewHolder(EfficientViewHolder viewHolder, int position) {
        ...
        viewHolder.onBindView(object, position, mBaseAdapter.size(), mIsScrolling);
